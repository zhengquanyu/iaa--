define("wxSubContext/@babel/runtime/helpers/Objectvalues.js", function(require, module, exports) {
...
define("wxSubContext/@babel/runtime/helpers/typeof.js", function(require, module, exports) {
    function _typeof(o) {
...
define("wxSubContext/engine.js", function(require, module, exports) {
    "use strict";

    require("../wxSubContext/@babel/runtime/helpers/Objectvalues");
    var _typeof3 = require("../wxSubContext/@babel/runtime/helpers/typeof");
...
define("wxSubContext/render/dataDemo.js", function(require, module, exports) {
    "use strict";
...
define("wxSubContext/render/style.js", function(require, module, exports) {
    "use strict";
...
define("wxSubContext/render/template.js", function(require, module, exports) {
    "use strict";

    var dataDemo = require('./dataDemo');
    ...
    <view class="container" id="main">  
     <view class="rankList">
       ...
       <view class="selfListItem">  
                <view id="listItemUserData">  
                    <text class="listItemNum" value="{{=  it.selfInfo.index}}"></text>  
                      <image class="listHeadImg" src="{{= it.selfInfo.avatarUrl}}"></image>  
                    <text class="listItemName" value="{{= it.selfInfo.nickname}}"></text>  
                </view>  
                <text class="listItemScore" value="{{= it.selfInfo.rankScore}} "></text>  
            </view>  
    </view>
    */
    ...
    function anonymous(it) {
        ...
        if (arr1) {
            ...
            while (index < l1) {
                item = arr1[index += 1];
                out += ' <view class="listItem"> <view id="listItemUserData"> <text class="listItemNum" value="' + (index + 1) + '"></text> <image class="listHeadImg" src="' + item.avatarUrl + '"></image> <text class="listItemName" value="' + item.nickname + '"></text> </view> <text class="listItemScore" value="' + item.rankScore + ' "></text> </view> <view class="listItemOld"> </view> ';
            }
        }
        out += ' </scrollview> </view> <view class="selfListItem"> <view id="listItemUserData"> <text class="listItemNum" value="' + it.selfInfo.index + '"></text> <image class="listHeadImg" src="' + it.selfInfo.avatarUrl + '"></image> <text class="listItemName" value="' + it.selfInfo.nickname + '"></text> </view> <text class="listItemScore" value="' + it.selfInfo.rankScore + ' "></text> </view> </view>';
        return out;
    }
...
define("wxSubContext/index.js", function(require, module, exports) {
    "use strict";

    var style = require('./render/style');
    var template = require('./render/template');
    var Layout = require('./engine').default;
    var dataDemo = require('./render/dataDemo');
    var __env = GameGlobal.wx || GameGlobal.tt || GameGlobal.swan;
    var sharedCanvas = __env.getSharedCanvas();
    ...
    var middleY = 0;
    var middleHeight = 0;
    var TYPE_Y_DISTANCE_0 = 50;
    var TYPE_Y_DISTANCE_1 = -50;
    var TYPE_Y_DISTANCE_2 = -50;
    ...
    __env.onMessage(function(data) {
        if (data.type === 'engine' && data.event === 'viewport') {
            if (middleY == 0) middleY = data.y;
            middleHeight = data.height;
            data.height = middleHeight + 100;
            // getData(data);
            // updateViewPort(data);
            // draw();
        };
        if (data.event === "saveScore") {
            wx.setUserCloudStorage({
                ...
                success: function success(res) {
                    console.log('update score success!', res);
                },
        ...
        if (data.event === "refresh") {
            ...
            switch (data.type) {
                case "0":
                    newViewport.y = middleY + TYPE_Y_DISTANCE_0;
                    break;
                case "1":
                    newViewport.y = middleY + TYPE_Y_DISTANCE_1;
                    break;
                case "2":
                    newViewport.y = middleY + TYPE_Y_DISTANCE_2;
                    break;
            };
            getData(data, newViewport);
            // draw();
        };
        ...
        function getData(data, newViewport) {
            ...
            var Obj0 = {
                ...
                success: function success(e) {
                    ...
                    for (var index = 0; index < e.data.length; index++) {
                        var _e$data$index$KVDataL;
                        var score = Number(((_e$data$index$KVDataL = e.data[index].KVDataList[0]) === null || _e$data$index$KVDataL === void 0 ? void 0 : _e$data$index$KVDataL.value) || 0);
                        if (isNaN(score)) score = 0;
                        dataDemo.data[index] = {
                            rankScore: score,
                            avatarUrl: e.data[index].avatarUrl,
                            nickname: e.data[index].nickname
                        };
                    }
                    dataDemo.data = sortArrayByKey(dataDemo.data, "rankScore");
                    for (var _index = 0; _index < dataDemo.data.length; _index++) {
                        if (dataDemo.data[_index].avatarUrl == dataDemo.selfInfo.avatarUrl && dataDemo.data[_index].nickName == dataDemo.selfInfo.nickName) {
                            dataDemo.selfInfo.index = _index + 1;
                        }
                    }
                    console.log('0success', e);
                    draw();
                }
            };
            wx.getUserInfo({
                ...
                success: function success(res) {
                    ...
                    if (isNaN(score)) score = 0;
                    dataDemo.selfInfo.nickname = res.data[0].nickName;
                    dataDemo.selfInfo.avatarUrl = res.data[0].avatarUrl;
                    dataDemo.selfInfo.rankScore = score;
                    wx.getFriendCloudStorage(Obj0);
                },
                fail: function fail(res) {
                    // reject(res)
                }
...
(typeof GameGlobal !== "undefined" ? GameGlobal : global).require("wxSubContext/index.js");